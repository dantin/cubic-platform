...
public class EmbeddedKeycloakConfig {
  ...
  @Bean
  public ServletListenerRegistrationBean<KeycloakSessionDestroyListener>
      keycloakSessionDestroyListener() {
    return new ServletListenerRegistrationBean<>(new KeycloakSessionDestroyListener());
  }

  @Bean
  public FilterRegistrationBean<KeycloakSessionServletFilter> keycloakSessionServletFilter(
  ...
  private void mockJndiEnvironment(DataSource dataSource) throws Exception {
