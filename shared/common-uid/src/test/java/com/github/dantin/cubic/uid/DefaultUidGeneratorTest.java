...
/** Unit test for {@link DefaultUidGenerator}. */
public class DefaultUidGeneratorTest extends UidGeneratorTest {

  @Before
  public void setUp() {
    uidGenerator = UidGenerator.defaultUidGeneratorBuilder(1L).build();
  }
